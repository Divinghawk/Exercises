...
class GigasecondTest {
	...
	@Test
	public void withFullTimeSpec() {
		Gigasecond gigaSecond = new Gigasecond(LocalDateTime.of(2015, Month.JANUARY, 24, 22, 0, 0));
	    Assert.assertEquals(LocalDateTime.of(2046, Month.OCTOBER, 2, 23, 46, 40), gigaSecond.getDateTime());
	}
	
	@Test
	public void modernTime() {
	    Gigasecond gigaSecond = new Gigasecond(LocalDate.of(2011, Month.APRIL, 25));
	    Assert.assertEquals(LocalDateTime.of(2043, Month.JANUARY, 1, 1, 46, 40), gigaSecond.getDateTime());
	}
	
	@Test
	public void beforeEpochTime() {
	    Gigasecond gigaSecond = new Gigasecond(LocalDate.of(1959, Month.JULY, 19));
	    Assert.assertEquals(LocalDateTime.of(1991, Month.MARCH, 27, 1, 46, 40), gigaSecond.getDateTime());
	}
	
	@Test
	public void afterEpochTime() {
	    Gigasecond gigaSecond = new Gigasecond(LocalDate.of(1977, Month.JUNE, 13));
	    Assert.assertEquals(LocalDateTime.of(2009, Month.FEBRUARY, 19, 1, 46, 40), gigaSecond.getDateTime());
	}
	...
	public void withFullTimeSpecifiedAndDayRollover() {
	    ...
	    Assert.assertEquals(LocalDateTime.of(2046, Month.OCTOBER, 3, 1, 46, 39), gigaSecond.getDateTime());
	}
}
